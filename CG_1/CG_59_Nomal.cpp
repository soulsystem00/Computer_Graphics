...
void drawScene()
{
    ...
    glEnable(GL_LIGHTING);  // Á¶¢Ò¸í¬iÈ¿¢¯°ú? »ç?¿ë¯e
    glEnable(GL_LIGHT0);    // 0¹øö©?Á¶¢Ò¸í¬i»ç?¿ë¯e
    glEnable(GL_LIGHT1);    // 1¹øö©?Á¶¢Ò¸í¬i»ç?¿ë¯e
    glEnable(GL_NORMALIZE); // ¹ý?¼±ù¡?º¤¬¢?ÅÍI¿Í¯I´Ü¥UÀ§¡×¹ý?¼±ù¡?º¤¬¢?ÅÍI ÀÚUµ¿ì¢?°è?»ê?
